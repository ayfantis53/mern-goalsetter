...
#### Initiate K8s.
- Create repos **[mern-goalsetter-client]** and **[mern-goalsetter-server]** in Dockerhub before pushing images there. Need images in Dockerhub because thats where Kubernetes manifest files pull it from.
